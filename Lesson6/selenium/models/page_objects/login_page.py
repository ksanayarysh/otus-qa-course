...
class LoginPage(BasePage):
    ...
    def set_username(self, username):
        self.driver.find_element(*LoginPageLocators.USERNAME).send_keys(Keys.CONTROL + "a")
        self.driver.find_element(*LoginPageLocators.USERNAME).send_keys(Keys.BACK_SPACE)
        self.driver.find_element(*LoginPageLocators.USERNAME).send_keys(username)

    def set_password(self, password):
        self.driver.find_element(*LoginPageLocators.PASSWORD).send_keys(Keys.CONTROL + "a")
        self.driver.find_element(*LoginPageLocators.PASSWORD).send_keys(Keys.BACK_SPACE)
